...
<head>
  ...
  <?php
    ...
    $sql = "SELECT * FROM questao WHERE disciplina = '{$_SESSION['disciplina']}' and assunto =  '$assunto'";
...
<body>
  ...
  <main>
    ...
    <form action="validar.php" method="POST">
      <div class="input">
        <span style="font-weight: bold;">Questões</span>
        <?php
          $c = 0;
      ...
      <button class='button' id="btn" disabled>Cadastrar</button>
    </form>
  </main>
  <script>
    let sel = [];
